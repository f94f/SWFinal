...
public class ItemTest {
    ...
    private String fechaCaducidad1 = "17/05/2014" ;
    private String motivoIngreso1 = "111";
    private String motivoSalida1 = "BBBBBB";
    
    private String name2 = "ZZZZZZZ";
    private String fechaCaducidad2 = "17/05/2013" ;
    private String motivoIngreso2 = "999";
    private String motivoSalida2 = "YYYYYYYY";
 ...
 //       driver.findElement(By.id("esPerecedero")).click();
        ...
        for (WebElement webElement : table) {
            ...
            if (elems.get(0).getText().equals(name1) 
                    && Integer.parseInt(elems.get(1).getText().split("/")[0]) == (Integer.parseInt(fechaCaducidad1.split("/")[0]))
                    && Integer.parseInt(elems.get(1).getText().split("/")[1]) == (Integer.parseInt(fechaCaducidad1.split("/")[1]))
                    && Integer.parseInt(elems.get(1).getText().split("/")[2]) == (Integer.parseInt(fechaCaducidad1.split("/")[2]))
    ...
    public void testUpdateProveedor() throws Exception {
        ...
        for (WebElement webElement : table) {
            ...
            if (elems.get(0).getText().equals(name2) 
                    && Integer.parseInt(elems.get(1).getText().split("/")[0]) == (Integer.parseInt(fechaCaducidad2.split("/")[0]))
                    && Integer.parseInt(elems.get(1).getText().split("/")[1]) == (Integer.parseInt(fechaCaducidad2.split("/")[1]))
                    && Integer.parseInt(elems.get(1).getText().split("/")[2]) == (Integer.parseInt(fechaCaducidad2.split("/")[2]))
