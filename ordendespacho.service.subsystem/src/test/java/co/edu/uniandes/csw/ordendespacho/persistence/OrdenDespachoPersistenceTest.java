...
public class OrdenDespachoPersistenceTest {
	...
	private void insertData() {
		for(int i=0;i<3;i++){
			...
			entity.setNombreItem(generateRandom(String.class));
			em.persist(entity);
			data.add(entity);
		}
	}
	...
	public void createOrdenDespachoTest(){
		...
		dto.setNombreItem(generateRandom(String.class));
		...
		Assert.assertEquals(dto.getNombreItem(), entity.getNombreItem());	
	}
	...
	public void getOrdenDespachoTest(){
		...
		Assert.assertEquals(entity.getNombreItem(), dto.getNombreItem());
	...
	public void updateOrdenDespachoTest(){
		...
		Assert.assertEquals(dto.getNombreItem(), resp.getNombreItem());	
	}
